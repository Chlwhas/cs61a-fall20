...
def roll_dice(num_rolls, dice=six_sided):
    ...
    while k > 0:
        ...
        sum += value
        k -= 1
    return 1 if is_pig_out else sum
    # END PROBLEM 1
...
def play(strategy0, strategy1, score0=0, score1=0, dice=six_sided,
    ...
    while score0 < goal and score1 < goal:
        ...
        while extra_turn(score0, score1):
            score0 += take_turn(strategy0(score0, score1), score1, dice)
            say = say(score0, score1)
            if score0 >= goal: return score0, score1
        ...
        while extra_turn(score1, score0):
            score1 += take_turn(strategy1(score1, score0), score0, dice)
            say = say(score0, score1)
            if score1 >= goal: return score0, score1
    # END PROBLEM 5
...
def extra_turn_strategy(score, opponent_score, cutoff=8, num_rolls=6):
    ...
    """
    # BEGIN PROBLEM 11
    if bacon_strategy(score, opponent_score, cutoff, num_rolls) == 0 or extra_turn(score + free_bacon(opponent_score), opponent_score):
        return 0
    return num_rolls
    # return 6  # Replace this statement
    # END PROBLEM 11
