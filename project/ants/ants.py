    ...
    def add_to(self, place):
        if place.ant is None:
            ...
            if place.ant.can_contain(self):
                ...
                protected_ant = place.ant
                place.ant = self
                place.ant.contain_ant(protected_ant)
            else:
...
class ThrowerAnt(Ant):
    ...
    def nearest_bee(self, beehive):
        ...
        """
        current_place, target_place = self.place, self.place

        for _ in range(self.min_range):
            if current_place.entrance is not None:
        ...
        while not bee:
            if current_place.entrance == beehive:
                return None
            elif current_place == target_place:
                return None
            elif current_place.entrance is not None:
                current_place = current_place.entrance
                bee = rANTdom_else_none(current_place.bees)
            else:
                return None
...
class QueenAnt(ScubaThrower):  # You should change this line
    ...
    def __init__(self, armor=1):
        ...
        self.queen_id = QueenAnt.queen_id + 1
        QueenAnt.queen_id += 1
        # END Problem EC
    ...
    def action(self, gamestate):
        ...
        if self.queen_id != 1:
            ...
            while search_place is not None:
                behind_ant = search_place.ant
                if behind_ant is not None and behind_ant.is_not_enforced:
                    behind_ant.damage = behind_ant.damage * 2
                    behind_ant.is_not_enforced = False
    ...
    def reduce_armor(self, amount):
        ...
        "*** YOUR CODE HERE ***"
        Ant.reduce_armor(self, amount)
        if self.armor <= 0 and self.queen_id == 1:
            bees_win()
        # END Problem EC
...
class Bee(Insect):
    ...
    def blocked(self):
        ...
        current_place_ant = self.place.ant
        return current_place_ant and current_place_ant.blocks_path
...
class NinjaAnt(Ant):
    ...
    def action(self, gamestate):
        ...
        "*** YOUR CODE HERE ***"
        current_bees = self.place.bees[:]
        for every_bee in current_bees:
            every_bee.reduce_armor(self.damage)
        # END Problem Optional 1
